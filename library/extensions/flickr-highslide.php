...
function flickr_highslide($atts=false){
    extract(shortcode_atts(array(
        'set' => 'Charles Millican Through the Years' # get_option('photoset')
    ), $atts));
	//get values from the backend
	$apikey = 'e62c043f8d2687f256c2f5436579c530'; # get_option('key');
	$id = '36226710@N08'; # get_option('id');
	$imageNum = 28; # get_option('imageNum');
